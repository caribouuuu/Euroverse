...
//	}
	...
	public static final String WEB_DRIVER_PATH = "/home/Downloads/chromedriver";
	...
	public String searchRoom(@ModelAttribute("room")Room room , Model model) throws Exception {
		...
		options.addArguments("headless");	//0414 화요일 추가
		...
		try {
            ...
            //return;
        	return "forward:/view/plan/planNotice.jsp";
        }
...
//			webElement.click();
			...
			/////////////////////////////////////이미지////////////////////////////////////////////////////
			  ...
			  for(String tempt : styleList) {
				  ...
				  //경로 꼭 수정하기!!!
				  //String savePath = "C:\\Users\\User\\git\\Euroverse\\ksy\\WebContent\\resources\\images\\roomImg\\";
				  //"C:\\Users\\User\\git\\repository\\Exhibition\\11.Model2MVCShop\\WebContent\\images\\uploadFiles\\";
				  String savePath = "/var/lib/tomcat8/webapps/ROOT/resources/images/roomImg";
			  ...
			  for(WebElement down : bigImg) {
			   ...
			   List<String> imgSrc = new ArrayList<String>();
				  ...
				  String savePath =
						  ...
						  "/var/lib/tomcat8/webapps/ROOT/resources/images/roomImg";
